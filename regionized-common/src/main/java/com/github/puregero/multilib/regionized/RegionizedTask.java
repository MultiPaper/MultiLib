...
public interface RegionizedTask {
     ...
     */
    @NotNull
    RegionizedTask.CancelledState cancel();
     ...
     */
    @NotNull
    RegionizedTask.ExecutionState getExecutionState();

    /**
     * Returns whether the current execution state is {@link RegionizedTask.ExecutionState#CANCELLED} or {@link RegionizedTask.ExecutionState#CANCELLED_RUNNING}.
     * @return whether the current execution state is {@link RegionizedTask.ExecutionState#CANCELLED} or {@link RegionizedTask.ExecutionState#CANCELLED_RUNNING}.
     */
    default boolean isCancelled() {
        final RegionizedTask.ExecutionState state = this.getExecutionState();
        return state == RegionizedTask.ExecutionState.CANCELLED || state == RegionizedTask.ExecutionState.CANCELLED_RUNNING;
    }

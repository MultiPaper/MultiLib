...
import com.github.puregero.multilib.regionized.paper.PaperRegionizedLibImpl;
...
public class MultiLib {
    ...
    private static RegionizedLib getRegionizedLib() {
        ...
        return regionizedLib = new BukkitRegionizedLibImpl();
    }
    ...
    /**
     * Returns whether the chunk is owned by the current thread or not.
     *
     * @return True if the chunk is owned by the current thread, false otherwise.
     */
    public static boolean isOwnedByCurrentRegion(World world, int chunkX, int chunkZ) {
        return getRegionizedLib().isOwnedByCurrentRegion(world, chunkX, chunkZ);
    }

    /**
     * Returns whether the location is owned by the current thread or not.
     *
     * @return True if the location is owned by the current thread, false otherwise.
     */
    ...
    /**
     * Returns whether the entity is owned by the current thread or not.
     *
     * @return True if the entity is owned by the current thread, false otherwise.
     */
     ...
     *
     * @return a future that will be completed once the chunk is loaded
     */
    public static @NotNull CompletableFuture<Chunk> getChunkAtAsync(World world, int chunkX, int chunkZ, boolean gen, boolean urgent) {
        return getRegionizedLib().getChunkAtAsync(world, chunkX, chunkZ, gen, urgent);
    }
     ...
     * @return a future that will be completed once the chunk is loaded
     */
    public static @NotNull CompletableFuture<Chunk> getChunkAtAsync(World world, int chunkX, int chunkZ, boolean gen) {
        return getRegionizedLib().getChunkAtAsync(world, chunkX, chunkZ, gen);
    }
     ...
     * @return a future that will be completed once the chunk is loaded
     */
    public static @NotNull CompletableFuture<Chunk> getChunkAtAsync(World world, int chunkX, int chunkZ) {
        return getRegionizedLib().getChunkAtAsync(world, chunkX, chunkZ);
    }

    /**
     * Get the chunk at the specified location asynchronously.
     *
     * @return a future that will be completed once the chunk is loaded
     */
     ...
     * @return a future that will be completed once the entity is teleported
     */
    public static @NotNull CompletableFuture<Boolean> teleportAsync(Entity entity, Location location, PlayerTeleportEvent.TeleportCause cause) {
        return getRegionizedLib().teleportAsync(entity, location, cause);
    }
}
